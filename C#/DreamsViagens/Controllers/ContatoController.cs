...
namespace DreamsViagens.Controllers
{
    public class ContatoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Contato,Nome,Email,Mensagem")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Contato,Nome,Email,Mensagem")] Contato contato)
        {
